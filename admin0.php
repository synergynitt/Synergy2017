              ...
              while($groupRegisteredForEvent = $selectEventResult->fetch_assoc()){
                ...
                if ($selectGroupMembersResult->num_rows>0){
                  while ($groupMember = $selectGroupMembersResult->fetch_assoc()){
                    ...
                    $rollno = $username['rollno'];
                    $phone = $username['phone'];
                    $groupMembers .= $name . ", ";
                    $groupMembersRollnos.= $rollno . ", ";
                    $groupMembersEmails.= $email . ", ";
                    $groupMembersColleges.= $college . ", ";
                    $groupMembersPhone.= $phone . ", ";
                  }
                }
                ?>
                <tr>
                  ...
                  <td><?php $groupMembersRollnos = trim($groupMembersRollnos, ", "); echo $groupMembersRollnos ?></td>
                  <td><?php $groupMembersEmails = trim($groupMembersEmails, ", "); echo strtolower($groupMembersEmails) ?></td>
                  <td><?php $groupMembersPhone = trim($groupMembersPhone, ", "); echo $groupMembersPhone ?></td>
                  <td><?php $groupMembersColleges = trim($groupMembersColleges, ", "); echo strtolower($groupMembersColleges) ?></td>
                </tr>
                <?php
              }
            }
